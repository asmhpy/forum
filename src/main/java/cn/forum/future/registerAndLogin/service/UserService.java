package cn.forum.future.registerAndLogin.service;

import cn.forum.future.registerAndLogin.dao.UserMapper;
...
public class UserService {
    ...
    public Result regist(User user) {
        ...
        try {
            User existUser = userMapper.findUserByName(user.getAdminName());
            if(existUser != null){
                //如果用户名已存在
